...
import './Main_Content_Cashback.css'
...
const Main_Content_Cashback=()=>{
    return(
        <div className="Main_Content_Cashback_scrollable_container">
                <div className="App">
...
export default Main_Content_Cashback;